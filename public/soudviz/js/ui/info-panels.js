...
class InfoPanels {
    ...
    getAbstractArtInfo() {
        return `
            <h4>Art Abstrait</h4>
            <p>Cette visualisation traduit les caractéristiques audio en compositions artistiques dynamiques,
            s'inspirant de différents styles d'art abstrait comme Mondrian, Kandinsky ou le minimalisme.</p>
            <p>Les paramètres audio peuvent être associés à différentes caractéristiques visuelles :</p>
            <ul>
                <li><strong>Couleur</strong> : Modifiée en fonction de la caractéristique audio sélectionnée</li>
                <li><strong>Taille</strong> : Les formes grandissent et rétrécissent selon l'énergie audio</li>
                <li><strong>Position</strong> : Les formes se déplacent en fonction des variations spectrales</li>
            </ul>
            <p>Utilisez les contrôles de Mapping pour personnaliser les associations entre les caractéristiques 
            sonores et visuelles. L'option <strong>Valeur Statique</strong> vous permet de fixer un paramètre 
            à une valeur constante.</p>
            <p>Le curseur de <strong>Réactivité</strong> contrôle l'intensité de la réaction aux changements audio - 
            des valeurs plus élevées créent des mouvements plus dramatiques et des changements plus prononcés.</p>
            <p>Les visualisations réagissent particulièrement aux battements et aux transitions sonores 
            avec des effets lumineux, des changements de couleurs et des animations.</p>
        `;
    }
