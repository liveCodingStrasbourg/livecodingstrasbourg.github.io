...
class InfoPanelsManager {
    ...
    initEvents() {
        ...
        if (this.infoPanels.panel1) {
            this.infoPanels.panel1.style.display = 'none';
        }

        if (this.infoPanels.panel2) {
            this.infoPanels.panel2.style.display = 'none';
        }
        ...
        // Add event listeners for visualization type changes
    ...
    togglePanel(panelId) {
        ...
        if (this.panelState[panelId]) {
            ...
            // Add animation class after a small delay to ensure it applies
            setTimeout(() => {
    ...
    /**
     * Update all panels based on current visualization types
     */
    updateAllPanels() {
        const type1 = document.getElementById('visualizationType1').value;
        const type2 = document.getElementById('visualizationType2').value;

        this.updatePanelContent('panel1', type1);
        this.updatePanelContent('panel2', type2);
    }
...
// Create a single global instance when document is loaded
document.addEventListener('DOMContentLoaded', () => {
    // Create a single global instance that will be used throughout the application
    window.infoPanels = new InfoPanelsManager();
});
